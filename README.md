...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinx-sitemap-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11409&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinx-sitemap-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinx-sitemap` can be installed with:

```
conda install sphinx-sitemap
```

It is possible to list all of the versions of `sphinx-sitemap` available on your platform with:
